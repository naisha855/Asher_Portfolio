        ...
        return (
            <>
                <div className=' skill_icon_title ' >
                    <h3 className={open} >저는 이런걸 할 수 있습니다</h3>
                    <div className='skill_title_page'>
                        <img className={open2} src={process.env.PUBLIC_URL + '/img/Design.png'} />
                        <h4  className={open3}>수원과학대학교 산업디자인학과를 졸업하였으며, 그래픽 디자인/영상 디자인/CAD/3D랜더링/제품 디자인 등을  이해하고 툴을 다룰 수 있습니다.</h4>
                    </div>
                    <div className='skill_title_page'>
                        <img className={open2} src={process.env.PUBLIC_URL + '/img/Code.png'} />
                        <h4  className={open3}>연세IT미래교육원 [스마트웹&콘텐츠개발] UIUX디자인&프론트엔드 개발자 양성과정을 수료하여 프론트엔드 웹 개발을 할 수 있습니다. </h4>
                    </div>
                    <h5 className={open4}>우측의 버튼을 눌러주세요.</h5>
                </div>
            </>
        )
    } else if (tab === 1) {
