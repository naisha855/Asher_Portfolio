            ...
            <>
                ...
                <div className='skill_icon_list'>
                    <div className='skill_icon' style={{ borderColor: '#9b59b6' }}>
                        ...
                        <h6>명령어를 사용한 <br />레파지토리 <br />접근과<br /> 버전 관리가 <br />가능</h6>
                    </div>
                </div>
            </>
        )
